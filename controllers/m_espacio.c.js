const mantenimientoModel = require ('../models/m_espacio.m')
...
class mantenimientoControllers {
    ...
    agregar(parametro){
        ...
        return new Promise((resolve, reject) => {
          ...
          if (!parametro || !parametro.espacio_mantenimiento || !parametro.personal_encargado || !parametro.fecha || !parametro.motivo) {
